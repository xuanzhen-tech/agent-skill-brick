...
import { createAgentSkillRuntimeContract } from "../main/launch-config.mjs";
...
await writeJsonIntoRuntime("package.json", {
  name: "@xuanzhen-tech/agent-skill-runtime",
  version: brickDefinition.version,
  private: true,
  type: "module",
  exports: "./src/index.mjs",
  bin: {
    "agent-skill": "./src/cli.mjs"
  }
});

await writeJsonIntoRuntime("runtime-contract.json", createAgentSkillRuntimeContract({
  platform: "win32-x64"
}));
