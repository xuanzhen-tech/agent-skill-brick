...
description: "用于 Amazon 相关服务状态沟通场景，整理系统可用性、故障影响、更新时间和恢复进度，输出对外状态说明。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-public-status-page"
originKind: "template"
---

# Public Status Page：Amazon 监控与运营看板

面向 Amazon 跨境卖家的监控与运营看板知识沉淀，围绕 Public Status Page 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Public Status Page：Amazon 监控与运营看板
