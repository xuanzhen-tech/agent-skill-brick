...
description: "用于 Amazon 相关页面和关键流程可用性巡检场景，模拟访问、搜索、下单链路和接口响应，输出可用性报告。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-synthetic-monitoring"
originKind: "template"
---

# Synthetic Monitoring：Amazon 监控与运营看板

面向 Amazon 跨境卖家的监控与运营看板知识沉淀，围绕 Synthetic Monitoring 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Synthetic Monitoring：Amazon 监控与运营看板
