---
name: "e-commerce-video-marketing"
description: "用于 Amazon 商品视频和站外短视频规划场景，提炼卖点、脚本、场景、证据和投放指标，输出视频内容方案。"
version: 0.1.0
collection: ecosystem
displayName: "电商视频营销"
platforms: ["amazon"]
sceneTags: ["advertising-growth"]
searchTags: ["amazon", "advertising-growth"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-ecommerce-video-marketing"
originKind: "template"
---

# E Commerce Video Marketing：Amazon 内容营销与站外承接

面向 Amazon 跨境卖家的内容营销与站外承接知识沉淀，围绕 E-Commerce Video Marketing 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：E Commerce Video Marketing：Amazon 内容营销与站外承接
