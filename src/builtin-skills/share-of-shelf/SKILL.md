---
name: "share-of-shelf"
description: "用于 Amazon 搜索结果和类目页面占位复盘场景，评估品牌露出、竞品排名、广告位和自然位，输出货架份额报告。"
version: 0.1.0
collection: ecosystem
displayName: "货架份额分析"
platforms: ["amazon"]
sceneTags: ["advertising-growth", "brand-compliance", "analytics-automation"]
searchTags: ["amazon", "advertising-growth", "brand-compliance", "analytics-automation"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-share-of-shelf"
originKind: "template"
---

# Share of Shelf：Amazon 监控与运营看板

面向 Amazon 跨境卖家的监控与运营看板知识沉淀，围绕 Share of Shelf 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Share of Shelf：Amazon 监控与运营看板
