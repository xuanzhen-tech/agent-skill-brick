...
description: "用于 Amazon 品牌保护和合规治理场景，整理跟卖、侵权、篡改、MAP破价和证据链，输出投诉路径与治理清单。"
version: 0.1.0
collection: ecosystem
displayName: "Amazon品牌保护"
platforms: ["amazon"]
sceneTags: ["brand-compliance"]
searchTags: ["amazon", "brand-compliance"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-brand-protection-amazon"
originKind: "template"
---

# brand protection amazon：Amazon 品牌保护与合规

面向 Amazon 跨境卖家的品牌保护与合规知识沉淀，围绕 brand-protection-amazon 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：brand protection amazon：Amazon 品牌保护与合规
