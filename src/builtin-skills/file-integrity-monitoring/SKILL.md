...
description: "用于 Amazon 运营资料和数据文件安全监控场景，跟踪关键文件变更、缺失、校验失败和异常访问，输出监控规则。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-file-integrity-monitoring"
originKind: "template"
---

# File Integrity Monitoring：Amazon 监控与运营看板

面向 Amazon 跨境卖家的监控与运营看板知识沉淀，围绕 File Integrity Monitoring 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：File Integrity Monitoring：Amazon 监控与运营看板
