...
description: "用于 Amazon 产品定位和卖点升级场景，分析竞品同质化、评价痛点、功能缺口和价格带，输出差异化方案。"
version: 0.1.0
collection: ecosystem
displayName: "Amazon产品差异化"
platforms: ["amazon"]
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-product-differentiation-amazon"
originKind: "template"
---

# product differentiation amazon：Amazon 选品与差异化

面向 Amazon 跨境卖家的选品与差异化知识沉淀，围绕 product-differentiation-amazon 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：product differentiation amazon：Amazon 选品与差异化
