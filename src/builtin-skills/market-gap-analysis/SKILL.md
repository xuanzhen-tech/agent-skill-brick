...
description: "用于 Amazon 新品机会和差异化定位场景，比较需求、竞品覆盖、评价痛点、价格带和供应能力，输出市场缺口报告。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-market-gap-analysis"
originKind: "template"
---

# market gap analysis：Amazon 选品与差异化

面向 Amazon 跨境卖家的选品与差异化知识沉淀，围绕 market-gap-analysis 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：market gap analysis：Amazon 选品与差异化
