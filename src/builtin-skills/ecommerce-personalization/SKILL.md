...
description: "用于 Amazon 站外触点和私域推荐场景，按人群、行为、购买阶段和品类偏好设计差异化内容，输出个性化策略。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-ecommerce-personalization"
originKind: "template"
---

# ecommerce personalization：Amazon Listing 与 SEO

面向 Amazon 跨境卖家的Listing 与 SEO知识沉淀，围绕 ecommerce-personalization 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：ecommerce personalization：Amazon Listing 与 SEO
