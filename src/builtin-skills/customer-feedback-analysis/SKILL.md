...
description: "用于 Amazon 买家反馈和售后问题复盘场景，归类评论、问答、退货原因和客服记录，输出问题主题与改进动作。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-customer-feedback-analysis"
originKind: "template"
---

# Customer Feedback Analysis：Amazon Listing 与 SEO

面向 Amazon 跨境卖家的Listing 与 SEO知识沉淀，围绕 Customer Feedback Analysis 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Customer Feedback Analysis：Amazon Listing 与 SEO
