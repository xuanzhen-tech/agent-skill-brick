...
description: "用于 Amazon 商品描述和卖点文案准备场景，基于人群、功能、证据和合规边界组织表达，输出可审核描述草案。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-product-description-generator"
originKind: "template"
---

# product description generator：Amazon 选品与差异化

面向 Amazon 跨境卖家的选品与差异化知识沉淀，围绕 product-description-generator 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：product description generator：Amazon 选品与差异化
