...
description: "用于 Amazon 产品评价复盘场景，拆解星级、主题、差评原因、竞品反馈和功能需求，输出产品改进优先级。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-product-review-analysis"
originKind: "template"
---

# product review analysis：Amazon 选品与差异化

面向 Amazon 跨境卖家的选品与差异化知识沉淀，围绕 product-review-analysis 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：product review analysis：Amazon 选品与差异化
