...
description: "用于 Amazon 评价风险和口碑质量检查场景，识别异常评价、差评主题、星级波动和合规风险，输出评价诊断报告。"
version: 0.1.0
collection: ecosystem
displayName: "Amazon评价检查"
platforms: ["amazon"]
sceneTags: ["customer-voice", "brand-compliance"]
searchTags: ["amazon", "customer-voice", "brand-compliance"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-amazon-review-checker"
originKind: "template"
---

# amazon review checker：Amazon 评论、口碑与反馈

面向 Amazon 跨境卖家的评论、口碑与反馈知识沉淀，围绕 amazon-review-checker 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：amazon review checker：Amazon 评论、口碑与反馈
