...
description: "用于 Amazon 品牌站外风险监控场景，发现仿冒域名、钓鱼页面、侵权落地页和跳转异常，输出风险清单与处理优先级。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-domain-monitoring"
originKind: "template"
---

# Domain Monitoring：Amazon 品牌保护与合规

面向 Amazon 跨境卖家的品牌保护与合规知识沉淀，围绕 Domain Monitoring 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Domain Monitoring：Amazon 品牌保护与合规
