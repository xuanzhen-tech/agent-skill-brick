---
name: "api-monitoring"
description: "用于 Amazon 经营数据接口和关键服务稳定性监控场景，跟踪可用性、延迟、错误率、字段完整性和告警阈值，输出监控方案。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-api-monitoring"
originKind: "template"
---

# API Monitoring：Amazon 监控与运营看板

面向 Amazon 跨境卖家的监控与运营看板知识沉淀，围绕 API Monitoring 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：API Monitoring：Amazon 监控与运营看板
