...
description: "用于 Amazon MAP政策和渠道价格治理场景，监控破价、授权卖家、证据截图和处理路径，输出价格治理清单。"
version: 0.1.0
collection: ecosystem
displayName: "最低广告价管理"
platforms: ["amazon"]
sceneTags: ["pricing-profit", "advertising-growth", "brand-compliance", "analytics-automation"]
searchTags: ["amazon", "pricing-profit", "advertising-growth", "brand-compliance", "analytics-automation"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-minimum-advertised-price"
originKind: "template"
---

# Minimum Advertised Price：Amazon 定价与利润

面向 Amazon 跨境卖家的定价与利润知识沉淀，围绕 Minimum Advertised Price 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Minimum Advertised Price：Amazon 定价与利润
