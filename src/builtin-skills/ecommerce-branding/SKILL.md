...
description: "用于 Amazon 品牌定位和页面资产规划场景，梳理目标人群、差异化、视觉语言、卖点和信任证据，输出品牌表达框架。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-ecommerce-branding"
originKind: "template"
---

# ecommerce branding：Amazon 品牌保护与合规

面向 Amazon 跨境卖家的品牌保护与合规知识沉淀，围绕 ecommerce-branding 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：ecommerce branding：Amazon 品牌保护与合规
