...
description: "用于 Amazon 品牌口碑和站外声量治理场景，监控评论、社媒、搜索结果和风险内容，输出声誉修复与维护计划。"
version: 0.1.0
collection: ecosystem
displayName: "在线声誉管理"
platforms: ["amazon"]
sceneTags: ["customer-voice", "brand-compliance", "analytics-automation"]
searchTags: ["amazon", "customer-voice", "brand-compliance", "analytics-automation"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-online-reputation-management"
originKind: "template"
---

# Online Reputation Management：Amazon 评论、口碑与反馈

面向 Amazon 跨境卖家的评论、口碑与反馈知识沉淀，围绕 Online Reputation Management 提供可执行分析流程、关键指标、输出模板和合规边界。

## 适用场景与边界

适用于 Amazon 卖家围绕 评论、口碑与反馈 做诊断、规划和复盘。可处理单个 ASIN、父子变体、SKU 组合或类目节点层面的运营问题，并把 Listing、广告、库存、价格、评论和品牌资产放在同一个 Amazon 经营语境下判断。

边界：输出经营分析和执行建议，不替代 Seller Central 后台数据、Amazon 官方费用表、法律意见或平台最终裁定。

## 输入信息清单

- 主题输入：ASIN 评论、星级、Verified Purchase、评论日期、变体、Q&A、退货原因、客服工单、Voice of Customer、竞品评论和 Vine 状态。
...
3. 执行主题分析：按星级、主题、时间和变体聚类；识别差评根因、异常评论增长和合规风险；转成产品、Listing、客服和供应链动作。
...
- VOC 主题表、差评优先级、产品改进 Backlog、客服话术和 Listing 修订建议。
...
主题：Online Reputation Management：Amazon 评论、口碑与反馈
...
2. 围绕 评论、口碑与反馈 建立证据表，区分必须立即处理的问题和可实验优化项。
