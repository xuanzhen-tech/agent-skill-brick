...
description: "用于 Amazon 价格波动监控场景，持续跟踪竞品售价、优惠、库存、Buy Box和促销节点，输出变价提醒与应对建议。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-competitor-price-tracker"
originKind: "template"
---

# competitor price tracker：Amazon 定价与利润

面向 Amazon 跨境卖家的定价与利润知识沉淀，围绕 competitor-price-tracker 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：competitor price tracker：Amazon 定价与利润
