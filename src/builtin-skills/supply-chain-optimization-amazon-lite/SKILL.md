...
description: "用于 Amazon 供应链轻量优化场景，分析补货、库存、供应商、交期、成本和断货风险，输出供应链改进清单。"
version: 0.1.0
collection: ecosystem
displayName: "Amazon供应链优化"
platforms: ["amazon"]
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-supply-chain-optimization-amazon"
originKind: "template"
---

# supply chain optimization amazon lite：Amazon 供应链、库存与仓储

面向 Amazon 跨境卖家的供应链、库存与仓储知识沉淀，围绕 supply-chain-optimization-amazon-lite 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：supply chain optimization amazon lite：Amazon 供应链、库存与仓储
