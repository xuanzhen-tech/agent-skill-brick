...
description: "用于 Amazon 多站点本地化上线检查场景，审核语言、单位、尺码、合规词、文化表达和页面一致性，输出本地化问题清单。"
version: 0.1.0
collection: ecosystem
displayName: "本地化测试"
platforms: ["amazon"]
sceneTags: ["brand-compliance"]
searchTags: ["amazon", "brand-compliance"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-localization-testing"
originKind: "template"
---

# Localization Testing：Amazon Listing 与 SEO

面向 Amazon 跨境卖家的Listing 与 SEO知识沉淀，围绕 Localization Testing 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Localization Testing：Amazon Listing 与 SEO
