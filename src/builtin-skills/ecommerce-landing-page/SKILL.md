...
description: "用于 Amazon 站外引流落地页设计场景，梳理人群、卖点、证据、优惠、转化路径和追踪指标，输出页面结构建议。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-ecommerce-landing-page"
originKind: "template"
---

# ecommerce landing page：Amazon 内容营销与站外承接

面向 Amazon 跨境卖家的内容营销与站外承接知识沉淀，围绕 ecommerce-landing-page 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：ecommerce landing page：Amazon 内容营销与站外承接
