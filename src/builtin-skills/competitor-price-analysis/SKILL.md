...
description: "用于 Amazon 竞品价格复盘场景，比较价格带、优惠、配送方式、评分和转化影响，输出价格机会与风险判断。"
version: 0.1.0
collection: ecosystem
displayName: "竞品价格分析"
platforms: ["amazon"]
sceneTags: ["pricing-profit", "inventory-supply-chain", "brand-compliance", "analytics-automation"]
searchTags: ["amazon", "pricing-profit", "inventory-supply-chain", "brand-compliance", "analytics-automation"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-competitor-price-analysis"
originKind: "template"
---

# competitor price analysis：Amazon 定价与利润

面向 Amazon 跨境卖家的定价与利润知识沉淀，围绕 competitor-price-analysis 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：competitor price analysis：Amazon 定价与利润
