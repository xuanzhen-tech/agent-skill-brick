...
description: "用于 Amazon 与Walmart竞品价格对比场景，跟踪售价、优惠、库存和价格波动，输出渠道价格观察表。"
version: 0.1.0
collection: ecosystem
displayName: "Walmart价格追踪对标"
platforms: ["amazon", "walmart"]
sceneTags: ["pricing-profit", "inventory-supply-chain"]
searchTags: ["amazon", "walmart", "pricing-profit", "inventory-supply-chain"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-walmart-price-tracker"
originKind: "template"
---

# Walmart Price Tracker：Amazon 定价与利润

面向 Amazon 跨境卖家的定价与利润知识沉淀，围绕 Walmart Price Tracker 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Walmart Price Tracker：Amazon 定价与利润
