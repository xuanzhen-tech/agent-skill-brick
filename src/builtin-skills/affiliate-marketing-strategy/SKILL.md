...
description: "用于 Amazon 站外联盟推广规划场景，评估渠道、佣金、内容资产、转化链路和归因方式，输出合作策略与复盘指标。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-affiliate-marketing-strategy"
originKind: "template"
---

# Affiliate Marketing Strategy：Amazon 内容营销与站外承接

面向 Amazon 跨境卖家的内容营销与站外承接知识沉淀，围绕 Affiliate Marketing Strategy 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Affiliate Marketing Strategy：Amazon 内容营销与站外承接
