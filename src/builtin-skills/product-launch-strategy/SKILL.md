...
description: "用于 Amazon 新品上市规划场景，设计内容、广告、价格、库存、评价积累和复盘节奏，输出上市执行计划。"
version: 0.1.0
collection: ecosystem
displayName: "产品首发策略"
platforms: ["amazon"]
sceneTags: ["pricing-profit", "advertising-growth", "customer-voice", "inventory-supply-chain"]
searchTags: ["amazon", "pricing-profit", "advertising-growth", "customer-voice", "inventory-supply-chain"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-product-launch-strategy"
originKind: "template"
---

# product launch strategy：Amazon 选品与差异化

面向 Amazon 跨境卖家的选品与差异化知识沉淀，围绕 product-launch-strategy 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：product launch strategy：Amazon 选品与差异化
