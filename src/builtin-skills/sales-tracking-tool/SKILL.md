...
description: "用于 Amazon 销售表现跟踪场景，监测销量、收入、订单、促销、广告贡献和利润变化，输出销售复盘表。"
version: 0.1.0
collection: ecosystem
displayName: "销售追踪"
platforms: ["amazon"]
sceneTags: ["pricing-profit", "advertising-growth", "store-operations"]
searchTags: ["amazon", "pricing-profit", "advertising-growth", "store-operations"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-sales-tracking-tool"
originKind: "template"
---

# sales tracking tool：Amazon 监控与运营看板

面向 Amazon 跨境卖家的监控与运营看板知识沉淀，围绕 sales-tracking-tool 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：sales tracking tool：Amazon 监控与运营看板
