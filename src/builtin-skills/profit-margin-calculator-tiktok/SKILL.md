...
description: "用于 Amazon 与TikTok Shop渠道利润对比场景，核算佣金、广告、履约、退货和达人费用，输出利润对照建议。"
version: 0.1.0
collection: ecosystem
displayName: "TikTok渠道利润对标"
platforms: ["amazon", "tiktok-shop"]
sceneTags: ["pricing-profit", "advertising-growth"]
searchTags: ["amazon", "tiktok-shop", "pricing-profit", "advertising-growth"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-profit-margin-calculator-tiktok"
originKind: "template"
---

# profit margin calculator tiktok：Amazon 定价与利润

面向 Amazon 跨境卖家的定价与利润知识沉淀，围绕 profit-margin-calculator-tiktok 提供可执行分析流程、关键指标、输出模板和合规边界。

## 适用场景与边界

适用于 Amazon 卖家围绕 定价与利润 做诊断、规划和复盘。可处理单个 ASIN、父子变体、SKU 组合或类目节点层面的运营问题，并把 Listing、广告、库存、价格、评论和品牌资产放在同一个 Amazon 经营语境下判断。
...
- 主题输入：售价、采购成本、头程、关税、FBA/FBM 费用、Referral Fee、仓储费、退货率、ACOS/TACOS、竞品价格、优惠券、MAP 和 Buy Box。
...
3. 执行主题分析：定义最低净利率、MAP、公平定价和库存护栏；比较竞品到手价；按 Buy Box、CVR、ACOS、库存周转和现金流做敏感性分析。
...
- 利润拆解表、目标售价区间、促销计划、调价监控和成本优化优先级。
...
主题：profit margin calculator tiktok：Amazon 定价与利润
...
2. 围绕 定价与利润 建立证据表，区分必须立即处理的问题和可实验优化项。
