...
description: "用于 Amazon 付费搜索和展示广告规划场景，设计账户结构、预算、关键词、竞价和否词机制，输出PPC投放计划。"
version: 0.1.0
collection: ecosystem
displayName: "电商PPC策略规划"
platforms: ["amazon"]
sceneTags: ["listing-content", "advertising-growth"]
searchTags: ["amazon", "listing-content", "advertising-growth", "shopify"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-ecommerce-ppc-strategy-planner"
originKind: "template"
---

# ecommerce ppc strategy planner：Amazon 广告与增长

面向 Amazon 跨境卖家的广告与增长知识沉淀，围绕 ecommerce-ppc-strategy-planner 提供可执行分析流程、关键指标、输出模板和合规边界。

## 适用场景与边界

适用于 Amazon 卖家围绕 广告与增长 做诊断、规划和复盘。可处理单个 ASIN、父子变体、SKU 组合或类目节点层面的运营问题，并把 Listing、广告、库存、价格、评论和品牌资产放在同一个 Amazon 经营语境下判断。

边界：输出经营分析和执行建议，不替代 Seller Central 后台数据、Amazon 官方费用表、法律意见或平台最终裁定。

## 输入信息清单

- 主题输入：ASIN 阶段、SP/SB/SD 结构、预算、竞价、搜索词报告、自然排名、Buy Box、库存天数、毛利率和目标 TACOS。
...
3. 执行主题分析：按自动、手动、品牌词、竞品词、防守词拆分结构；用搜索词报告做收割和否词；把 ACOS、TACOS、ROAS、自然排名和库存消耗联动复盘。
...
主题：ecommerce ppc strategy planner：Amazon 广告与增长
...
2. 围绕 广告与增长 建立证据表，区分必须立即处理的问题和可实验优化项。
