...
description: "用于 Amazon 搜索词和内容布局场景，收集关键词、意图、竞争度、转化表现和页面覆盖，输出关键词分层表。"
version: 0.1.0
collection: ecosystem
displayName: "电商关键词研究"
platforms: ["amazon"]
sceneTags: ["listing-content"]
searchTags: ["amazon", "listing-content"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-ecommerce-keyword-research"
originKind: "template"
---

# ecommerce keyword research：Amazon 选品与差异化

面向 Amazon 跨境卖家的选品与差异化知识沉淀，围绕 ecommerce-keyword-research 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：ecommerce keyword research：Amazon 选品与差异化
