...
description: "用于 Amazon 竞品系统研究场景，比较定位、价格、页面、评价、广告、供应和差异化，输出竞品矩阵与机会点。"
version: 0.1.0
collection: ecosystem
displayName: "电商竞品分析"
platforms: ["amazon"]
sceneTags: ["pricing-profit", "advertising-growth", "customer-voice", "analytics-automation"]
searchTags: ["amazon", "pricing-profit", "advertising-growth", "customer-voice", "analytics-automation"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-ecommerce-competitor-analysis"
originKind: "template"
---

# ecommerce competitor analysis：Amazon 经营策略与多渠道协同

面向 Amazon 跨境卖家的经营策略与多渠道协同知识沉淀，围绕 ecommerce-competitor-analysis 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：ecommerce competitor analysis：Amazon 经营策略与多渠道协同
