...
description: "用于 Amazon 全渠道营销规划场景，整合广告、内容、社媒、邮件、促销和预算节奏，输出营销作战方案。"
version: 0.1.0
collection: ecosystem
displayName: "电商营销策略搭建"
platforms: ["amazon"]
sceneTags: ["advertising-growth"]
searchTags: ["amazon", "advertising-growth"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-ecommerce-marketing-strategy-builder"
originKind: "template"
---

# ecommerce marketing strategy builder：Amazon 经营策略与多渠道协同

面向 Amazon 跨境卖家的经营策略与多渠道协同知识沉淀，围绕 ecommerce-marketing-strategy-builder 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：ecommerce marketing strategy builder：Amazon 经营策略与多渠道协同
