...
description: "用于 Amazon 商品视频和站外可购物内容场景，设计脚本、卖点、商品卡、转化入口和复盘指标，输出视频转化方案。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-shoppable-video"
originKind: "template"
---

# Shoppable Video：Amazon 内容营销与站外承接

面向 Amazon 跨境卖家的内容营销与站外承接知识沉淀，围绕 Shoppable Video 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Shoppable Video：Amazon 内容营销与站外承接
