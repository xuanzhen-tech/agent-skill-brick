---
name: "restock-alert"
description: "用于 Amazon 库存预警和补货计划场景，监控可售天数、销量速度、生产周期、头程和仓储限制，输出补货提醒。"
version: 0.1.0
collection: ecosystem
displayName: "补货提醒"
platforms: ["amazon"]
sceneTags: ["inventory-supply-chain", "analytics-automation"]
searchTags: ["amazon", "inventory-supply-chain", "analytics-automation"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-restock-alert"
originKind: "template"
---

# Restock Alert：Amazon 供应链、库存与仓储

面向 Amazon 跨境卖家的供应链、库存与仓储知识沉淀，围绕 Restock Alert 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：Restock Alert：Amazon 供应链、库存与仓储
