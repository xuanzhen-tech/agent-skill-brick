...
description: "用于 Amazon 品牌合作、分销和供应链线索开发场景，筛选目标公司、联系人、职位和触达理由，输出拓客名单。"
version: 0.1.0
collection: ecosystem
displayName: "LinkedIn线索开发"
platforms: ["amazon"]
sceneTags: ["inventory-supply-chain", "brand-compliance"]
searchTags: ["amazon", "inventory-supply-chain", "brand-compliance"]
legacyEcosystemId: "noique-cross-border-ecommerce-skills-linkedin-prospecting"
originKind: "template"
---
...
## 操作流程
1. 定义 ICP 和排除条件。`n2. 搜公司，再找相关职位和决策链。`n3. 记录触达理由和共同语境。`n4. 发送个性化连接，不群发硬广。`n5. 跟进并同步 CRM。

所有建议都要能落到执行表：负责人、依赖数据、上线时间、观察窗口、成功标准和停止条件。

## 关键指标与判断标准
profile fit、acceptance rate、reply rate、meeting booked、wrong persona rate。
