...
description: "用于 Amazon 代发或轻库存选品评估场景，分析需求、供货稳定性、配送时效、利润和售后风险，输出可行性判断。"
version: 0.1.0
collection: ecosystem
displayName: "代发商品研究"
platforms: ["amazon"]
sceneTags: ["product-research", "pricing-profit", "customer-voice", "inventory-supply-chain", "brand-compliance", "analytics-automation"]
searchTags: ["amazon", "product-research", "pricing-profit", "customer-voice", "inventory-supply-chain", "brand-compliance", "analytics-automation"]
legacyEcosystemId: "nexscope-ai-ecommerce-skills-dropshipping-product-research"
originKind: "template"
---

# dropshipping product research：Amazon 选品与差异化

面向 Amazon 跨境卖家的选品与差异化知识沉淀，围绕 dropshipping-product-research 提供可执行分析流程、关键指标、输出模板和合规边界。

## 适用场景与边界

适用于 Amazon 卖家围绕 选品与差异化 做诊断、规划和复盘。可处理单个 ASIN、父子变体、SKU 组合或类目节点层面的运营问题，并把 Listing、广告、库存、价格、评论和品牌资产放在同一个 Amazon 经营语境下判断。

边界：输出经营分析和执行建议，不替代 Seller Central 后台数据、Amazon 官方费用表、法律意见或平台最终裁定。

## 输入信息清单

- 主题输入：候选 ASIN、类目节点、BSR、价格带、竞品评论、父子变体、采购成本、MOQ、认证、FBA 尺寸重量和补货周期。
...
3. 执行主题分析：用 ABA、Search Query Performance 和关键词排名确认需求；拆解竞品卖点、差评痛点、价格带和评论壁垒；合并毛利、合规、供应链和广告冷启动成本判断机会。
...
主题：dropshipping product research：Amazon 选品与差异化
...
2. 围绕 选品与差异化 建立证据表，区分必须立即处理的问题和可实验优化项。
