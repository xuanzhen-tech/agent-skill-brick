...
description: "用于 Amazon 评论和评分持续监控场景，跟踪新增差评、主题变化、星级波动和异常信号，输出口碑预警摘要。"
version: 0.1.0
...
legacyEcosystemId: "nexscope-ai-ecommerce-skills-review-monitoring"
originKind: "template"
---

# review monitoring：Amazon 评论、口碑与反馈

面向 Amazon 跨境卖家的评论、口碑与反馈知识沉淀，围绕 review-monitoring 提供可执行分析流程、关键指标、输出模板和合规边界。
...
主题：review monitoring：Amazon 评论、口碑与反馈
